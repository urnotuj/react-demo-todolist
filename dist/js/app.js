...
var APP = function (_React$Component) {
	...
	_createClass(APP, [{
		key: 'handleChange',
		value: function handleChange(rows) {
			this.setState({
				todolists: rows
			});
		}
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'forBorder' },
					_react2.default.createElement(_index2.default, { todo: this.state.todolists, onDel: this.handleChange.bind(this) }),
					_react2.default.createElement(_index4.default, { todo: this.state.todolists, onAdd: function onAdd(rows) {
							_this2.handleChange(rows);
						} })
				)
			);
		}
...
var TodoList = function (_React$Component) {
    ...
    _createClass(TodoList, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'ul',
                { className: 'list-todo list-unstyled' },
                ...
                this.props.todo.map(function (name, index) {
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'a',
                            { className: 'btn btn-default delbtn', href: '#', onClick: this.handleDel.bind(this), 'data-key': index, role: 'button' },
                            '\u5220\u9664'
                        )
                    );
                }.bind(this))
...
var AddNew = function (_React$Component) {
	...
	function AddNew(props) {
		...
		return _possibleConstructorReturn(this, (AddNew.__proto__ || Object.getPrototypeOf(AddNew)).call(this, props));
	}
	...
	_createClass(AddNew, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: 'row add-container form-group' },
				_react2.default.createElement('input', { type: 'text', ref: 'inputnew', className: 'form-control no-hundred-width', placeholder: '\u65B0\u589E\u4E00\u6761', onKeyUp: function onKeyUp(e) {
						_this2.handleEnter(e);
					} }),
				_react2.default.createElement(
					'button',
					{ className: 'addbtn btn btn-default', onClick: function onClick(e) {
